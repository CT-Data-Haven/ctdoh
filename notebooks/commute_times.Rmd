...
commute %>% 
	...
	geom_col(width = .7, position = position_dodge(.8), fill=pal[2]) +
	geom_text(aes(label = scales::percent(share, accuracy = 1)), position = position_dodge(.8), hjust = -.1, family = "Lato Regular") +
