...
hh_occ <- bind_rows(owner, renter) %>% 
	...
	geom_line(aes(color = hhlds), size = 1) +
	geom_text(aes(label = percent(share, accuracy = 1)), family = "Lato Regular", size = 3.25, vjust = -1.2) +
...
ggsave("../output_data/corrected_charts/hh_by_size_ct.png", dpi = 300, width = 6.5, height = 5)
