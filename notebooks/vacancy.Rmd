...
I'm using a slightly modified version of the Census definitions here https://www.census.gov/housing/hvs/definitions.pdf (modified because we would ideally add the "Rented or sold but not (yet) occupied" units, but we can't split those out by tenure). Further splitting SF and MF (2+ units in structure) units separately:
